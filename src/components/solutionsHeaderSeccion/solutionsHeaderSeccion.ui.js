...
const SolutionsHeaderSeccionUI = (props)=>{
    return (
        <div className="flex flex-col  md:flex-row">
            <div className="px-5 sm:pl-16 md:pl-24 lg:pl-32   py-12  md:w-1/2 w-full" style={{backgroundColor:'#17a59a'}}> 
                <h2 className="subtitle leading-none text-left text-white"> our Solutions </h2>
                <div className="flex mt-4">
                    <div className="mt-2 mr-2 h-full w-40 border border-solid border-b-1  border-wh white"/>
                        <div>
            ...
            <div className="px-5 sm:pl-16 md:pr-24 lg:pr-32   py-12  md:w-1/2 w-full bg-white "> 
                <h2 className="subtitle leading-none text-left text-gray-800"> why choose us </h2>
                <div className="flex mt-4">
...
export default SolutionsHeaderSeccionUI
